...
const Navbar = () => {
    ...
    <div id="nav" className="flex justify-between items-center h-28 max-w-[1240px] mx-auto px-4 text-white text-md md:text-xl z-40">
        ...
        <ul  className=" uppercase hidden md:flex">
           ...
           <Link to="projects" spy={true} smooth={true} offset={0} duration={700}><li className=" p-4 cursor-pointer"> Projects </li></Link> 
           <Link to="hero" spy={true} smooth={true} offset={0} duration={700}><li className=" p-4 cursor-pointer"> About </li></Link> 
           <Link to="contact" spy={true} smooth={true} offset={0} duration={700}><li className=" p-4 cursor-pointer"> Contact </li></Link> 
        </ul>
