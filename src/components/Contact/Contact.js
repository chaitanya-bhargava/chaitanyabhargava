  ...
  return (
    <div id="contact" className="flex flex-col items-center m-4">
      ...
      >
        ...
        <button
          type="submit"
          class="relative inline-flex items-center justify-center px-8 py-3 lg:px-10 lg:py-4 overflow-hidden tracking-tighter text-black font-bold bg-[#A8A29C] rounded-lg group p-3 m-4 text-xs xs:text-sm md:text-base hover:scale-110 duration-500"
        >
